...
// ---- END DEFINITIONS ----
// BOOKMARK (just using this to mark where I'm pausing) (got to fix error when trying to compile. Probably going to copy s_waveBufs into // design pattern START-END and comment these initializations out) bit confusing because I kept the same names
// ndspWaveBuf s_waveBufs[3];
// int16_t *s_audioBuffer = NULL;
