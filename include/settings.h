...
struct Settings {
    ...
    int speedPercent = 100;       // playback speed x100, SPEED_MIN_PERCENT-SPEED_MAX_PERCENT
    float pitchSemitones = 0.0f;  // pitch shift, PITCH_MIN_SEMITONES-PITCH_MAX_SEMITONES, 0.1 steps
